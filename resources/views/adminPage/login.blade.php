...
<body>
	<div id="container">
		<div id="logo">
			<img src="{{asset('assets/adminPage_assets/img/logo.png')}}" alt=""/>
		</div>
		<div id="user">
			<div class="avatar">
				<div class="inner"></div>
				<img src="{{asset('assets/adminPage_assets/img/demo/av1_1.jpg')}}" />
			</div>
			<div class="text">
		...
		<div id="loginbox">
			<form id="loginform" action="http://demo.bootstrap-hunter.com/unicorn/index.html">
...
<!-- Mirrored from demo.bootstrap-hunter.com/unicorn/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 Jan 2016 16:00:22 GMT -->
</html>
