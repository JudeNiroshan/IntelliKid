		...
		<div class="wrapper-holder">
			<header id="header">
				...
				<div class="bar-holder">
					...
					<nav id="nav">
						<ul>
							<li><a href="kids_about">About us</a></li>
			...
			<section class="promo">
				<div class="slider-wrap">
					<ul class="slider">
						<li>
							<img class="slide" src="{{asset('assets/kids_assets/images/img-slide01.jpg')}}" alt="">
							
							<img class="slide-mask" src="assets/kids_assets/images/bg_slider-mask.png" alt="">
						...
						<li>
							<img class="slide" src="assets/kids_assets/images/img-slide01.jpg" alt="">
							<img class="slide-mask" src="assets/kids_assets/images/bg_slider-mask.png" alt="">
							<div class="slide-info">
								<h1><a href="#">Education for kids</a></h1>
								<p>Accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi.</p>
					...
					<div class="widget-boxes news">
						...
						<div class="box">
							<a class="news-img" href="#">
								<img src="assets/kids_assets/images/img-news01.jpg" alt="" />
								<div class="mask"></div>
							</a>
							<div class="box-info">
						...
						<div class="box">
							<a class="news-img" href="#">
								<img src="assets/kids_assets/images/img-news02.jpg" alt="" />
								<div class="mask"></div>
							</a>
							<div class="box-info">
						...
						<div class="box">
							<a class="news-img" href="#">
								<img src="assets/kids_assets/images/img-news03.jpg" alt="" />
								<div class="mask"></div>
							</a>
							<div class="box-info">
