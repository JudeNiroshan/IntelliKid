...
<!-- Mirrored from themes.iamabdus.com/royal/1.1/international_students.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 Jan 2016 16:47:12 GMT -->
...
<head>
      ...
      <link rel="shortcut icon" href="{{URL::asset('assets/images/logo1.png') }}" type="image/png" sizes="48x48"/>
       ...
       <!-- <link rel="stylesheet" href="{{ URL::asset('assets/css/bootstrap-extend.min.css')}}">
        ...
        <link rel="stylesheet" href="{{ URL::asset('assets/parent/parent/vendor/bootstrap-datepicker/bootstrap-datepicker.css')}}">
...
block {
  ...
  <body background="{{ URL::asset('assets/parent/photos/0.jpg')}}">
            ...
            <div class="col-md-6 col-md-offset-3">
                <div class="panel panel-login">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-lg-12">
                                <form id="login-form" onsubmit="return validate()" id="reg12" style="display: block;">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-sm-6 col-sm-offset-3">
                                                <input type="submit" name="submit" id="submit" tabindex="4" class="form-control btn btn-login" value="SEND RESET PASSWORD LINK">
                                            </div>
                                        </div>
                                    </div>

                                     <div id="error" name="error" class="alert-link" style="color:red" ></div>
                                     <div id="load" style="padding-left:47%"></div>
...
<!-- jQuery -->
      ...
      function validate(){
        ...
        if(u_email==""){
            ...
            document.getElementById("error").innerHTML = "Pleace Enter your email!!";
                ...
                success: function (data) {
                 console.log(data.message);
                  console.log(data.email);
                    ...
                    if(data.message == 0){
                      swal("Sorry!", "This email dosen't have an account!", "warning")
...
<!-- Mirrored from themes.iamabdus.com/royal/1.1/international_students.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 Jan 2016 16:47:16 GMT -->
</html>