...
<input type="text" id="sid" name="sid" value="{{$d->id}}" hidden>
 <?php
...
?>
                    ...
                    <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2" style="left: 0%">
                      <div class="item">
                        <div class="pos-rlt">
                        <div class="bottom">
                ...
                <div class="grid grid_0 percentage">
                    <div class="nicdark_margin12 nicdark_relative">
                        ...
                        <div class="nicdark_activity nicdark_marginleft100 nicdark_disable_marginleft_ipadpotr">
                            <h4>NO MACHING RESULTS FOUND</h4>                        
...
@endsection
  ...
  <script type="text/javascript" src="assets/parent/js/jPlayer/demo3.js"></script>
