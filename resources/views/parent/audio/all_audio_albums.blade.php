...
<style>
	...
	<div class="grid grid_8" style="padding-left:26%">
          <form action="search_All_audios" method="get">
                    ...
                    <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                      <div class="item">
                        ...
                        <div class="bottom">
                          ...
                          <a href="#"><img src="{{$d->img_path}}" class="r r-2x img-full"></a>
                        </div>
                        <div class="padder-v">
...
@endsection
  ...
  <script type="text/javascript" src="assets/parent/js/jPlayer/demo2.js"></script>
