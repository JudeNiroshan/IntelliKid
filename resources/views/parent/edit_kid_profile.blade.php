                                                                ...
                                                                <div class="modal-body">
                                                                    <div class="avatar-body">
                                                                        ...
                                                                        <div class="avatar-upload">
                                                                            ...
                                                                            <input class="avatar-input btn btn-success"  id="avatarInput" name="avatarInput" type="file" value="{{$data[0]->img_path}}">
                                                                        </div>
		...
		<div class="grid grid_8">
           ...
           <div class="nicdark_archive1 nicdark_bg_grey nicdark_radius nicdark_shadow">
                ...
                <div class="nicdark_margin20">
                    <input class="nicdark_bg_grey2 nicdark_radius nicdark_shadow grey small subtitle" type="text" value="{{$data[0]->nik_name}}"  placeholder="PET NAME" id="nik_name" name="nik_name">
                    <div class="nicdark_space20"></div>
                    <input class="nicdark_bg_grey2 nicdark_radius nicdark_shadow grey small subtitle" type="text" value="{{$data[0]->f_name}}" placeholder="FIRST NAME" id="f_name" name="f_name">
                    <div class="nicdark_space20"></div>

                    <input class="nicdark_bg_grey2 nicdark_radius nicdark_shadow grey small subtitle" type="text"  value="{{$data[0]->l_name}}" placeholder="LAST NAME" id="l_name" name="l_name">
                    <div class="nicdark_space20"></div>

                     <select class="nicdark_bg_grey2 nicdark_radius nicdark_shadow grey small subtitle" type="text" placeholder="AGE" id="age" name="" ="age">
                    ...
                    <div class="nicdark_space20"></div>
                     ...
                     <div class="form-group">  
                    <input class="nicdark_bg_grey2 nicdark_radius nicdark_shadow grey small subtitle" type="password"  placeholder="PASSWORD" id="password" name="password" style="width:50%" value="{{$data[0]->kid_password}}">
                    <div class="nicdark_space20"></div>
                    </div>
                    <input class="nicdark_bg_grey2 nicdark_radius nicdark_shadow grey small subtitle" type="password"  placeholder="CONFIRM PASSWORD" id="con_password" name="con_password"  style="width:50%" value="{{$data[0]->kid_password}}">
                    <div class="nicdark_space20"></div>
 <div class="nicdark_space20"></div>
                    ...
                    <textarea class="nicdark_bg_grey2 nicdark_radius nicdark_shadow grey small subtitle" placeholder="BIO" rows="7" id="bio" name="bio" value="{{$data[0]->bio_data}}">{{$data[0]->bio_data}}</textarea>
                    <div class="nicdark_space20"></div>
             ...
             <input type="submit"  class="btn btn-info"  onclick="Clear()" value="Clear All"/>

                     <input type="submit" value="SAVE" class="btn btn-success"   onclick="return uploadFile()" >
...
_("progressBar").value = 0;
    ...
    formdata.append("img_data", img_data);
     ...
     formdata.append("id", {{$data[0]->c_id}});
    ...
    ajax.open("POST", "file_upload_save");
    ajax.send(formdata);
   } 
}
