...
<head>
      ...
      <link rel="shortcut icon" href="{{URL::asset('assets/images/logo1.png') }}" type="image/png" sizes="48x48"/>
       ...
       <!-- <link rel="stylesheet" href="{{ URL::asset('assets/css/bootstrap-extend.min.css')}}">
        ...
        <link rel="stylesheet" href="{{ URL::asset('assets/parent/parent/vendor/intro-js/introjs.css')}}">
        ...
        <link rel='stylesheet' href="{{ URL::asset('assets/parent/parent/ss/../fonts/font-awesome/font-awesome.css')}}">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="custom_title">
                            <h1>HELLO {{$name}}</h1>
                            <p>VERIFY YOUR ACCOUNT FROM HERE.... </p>
                        </div>
                    </div>
                </div><!--end row-->
                    ...
                    <div class="col-xs-12">
                        <ul class="list">
                            <li>
                                <a href="#">
                                    <div class="thumb">
                                        <img src="{{URL::asset('assets/photos/logo.png')}}"  alt="" />
