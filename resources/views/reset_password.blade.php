                            ...
                            <div class="col-lg-12">
                                <form id="login-form" onsubmit="return validate()" id="reg12" style="display: block;">
                                    <div class="form-group">
                                        <input type="password" name="password" id="password" class="form-control" placeholder="PASSWORD" requiered>
                                    </div>
                                    <div class="form-group">
                                        <input type="password" name="con_password" id="con_password" class="form-control" placeholder="CONFIRME PASSWORD" requiered>
                                    </div>
...
<!-- jQuery -->
      ...
      function validate(){
        ...
        if(password=="" || con_password ==""){
            ...
            document.getElementById("error").innerHTML = "Pleace Enter your password!!";
