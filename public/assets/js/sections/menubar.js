  ...
  $.site.menubar = {
    ...
    open: function() {
      if (this.opened !== true) {
        this.animate(function() {
          $body.removeClass('site-menubar-hide').addClass(' ');
          this.opened = true;
    ...
    hide: function() {
      ...
      if (this.opened !== false) {
        this.animate(function() {
          $body.removeClass('site-menubar-open').addClass('   ');
          this.opened = false;
    ...
    unfold: function() {
      ...
      if (this.folded !== false) {
        this.animate(function() {
          $body.removeClass('site-menubar-fold').addClass(' ');
          this.folded = false;
    ...
    fold: function() {
      ...
      if (this.folded !== true) {
        this.animate(function() {
          $body.removeClass('site-menubar-unfold').addClass(' ');
          this.folded = true;
