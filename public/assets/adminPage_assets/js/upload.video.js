		...
		success: function(data){
			...
			bootbox.dialog({
				...
				message: '<div class="row">  ' +
				    '<div class="col-md-12"> ' +
				    '<form method="post" id="popup-form" action="upload_save_edit_video" class="form-horizontal"> ' +
				    '<div class="form-group"> ' +
				    '<label class="col-md-4 control-label" >Video ID</label> ' +
				    '<div class="col-md-4"> ' +
				    '<input value="'+data['v_id']+'" type="text" disabled="yes" class="form-control input-md"></input> ' +
				    ...
				    '<div class="col-md-8"> ' +
				    '<input name="video_name" maxlength="20" value="'+data['video_name'][0]['name']+'" type="text" class="form-control input-md"/>' +
				    '</div> </div>'+
